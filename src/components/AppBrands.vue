        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-3 col-md-6 col-12"><img src="../assets/img/images-4.png" alt="Brand 4" class="img-fluid"></div>
                </div>
            </div>
            ...
            <div class="carousel-item">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-3 col-md-6 col-12"><img src="../assets/img/images-8.png" alt="Brand 8" class="img-fluid"></div>
                </div>
            </div>
            ...
            <div class="carousel-item">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-3 col-md-6 col-12"><img src="../assets/img/images-12.png" alt="Brand 12" class="img-fluid"></div>
                </div>
            </div>
        </div>
